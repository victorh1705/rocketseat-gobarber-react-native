...
import {
  ...
  Hour,
  HourText,
  CreateAppoinmtmentButton,
  CreateAppoinmtmentText,
} from './styles';
  ...
  return (
    <Container>
      ...
      <Content>
        ...
        <CreateAppoinmtmentButton onPress={handleCreateAppointment}>
          <CreateAppoinmtmentText>Agendar</CreateAppoinmtmentText>
        </CreateAppoinmtmentButton>
      </Content>
    </Container>
  );
